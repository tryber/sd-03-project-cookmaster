...
const getUserRecipes = async (req, res) => {
  ...
  return res.render('admin/newRecipe', { recipes, user: req.user });
};
...
const deleteRecipe = async (req, res) => {
  ...
  // The recipe should only be deleted if the password is correct.
  // If it is incorrect, the person should be redirected to the recipe exclusion page
  // with the message "Senha incorreta."
